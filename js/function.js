...
/*
    ...
    滚轮滚动事件(obj,upcallwheel,downcallwheel)
...
*/
function scrollWheel(obj,upcallwheel,downcallwheel){
	if(obj.attachEvent){
	...
	function scrollFn(e){
		...
		if(val==120||val==-3||val==-1){
			upcallwheel&&upcallwheel.call(obj);
		}
		if(val==-120||val==3||val==1){
			downcallwheel&&downcallwheel.call(obj);
		}
